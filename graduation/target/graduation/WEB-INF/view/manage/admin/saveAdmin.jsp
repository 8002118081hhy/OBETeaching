...
<form class="layui-form layui-form-pane" action="" style="width:80%;margin:0 auto;margin-top: 2%;" id="saveAdminForm"
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="adminname" lay-verify="required" name="adminname" placeholder="请输入用户名"
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="admineamil" lay-verify="required" name="admineamil" placeholder="请输入邮箱"
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="adminpassword" lay-verify="required" name="adminpassword" placeholder="请输入密码"
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" id="adminphone" lay-verify="required" name="adminphone" placeholder="请输入电话"
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <select id="role" name="role" class="layui-select">
                ...
                <option value="教师"  ${"教师"==admin.role?'selected':''}>教师</option>
