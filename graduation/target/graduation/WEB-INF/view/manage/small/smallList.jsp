...
<blockquote class="layui-elem-quote list_search">
    <div class="layui-inline">
        <a class="layui-btn layui-btn-normal smallachive"><i class="layui-icon">&#xe62c;</i> 二级毕业要求达成情况</a>
    </div>
    <div class="layui-inline">
        <a class="layui-btn layui-btn-normal addBtn"><i class="layui-icon">&#xe608;</i> 添加</a>
    </div>
    <div class="layui-inline">
...
<!-- 数据表格 -->
<table id="smallList" lay-filter="test"></table>
<script type="text/javascript" src="${ctx}/static/layui/layui.js"></script>

<script type="text/javascript" src="${ctx}/static/js/common.js"></script>
<script type="text/javascript" src="${ctx}/view/manage/small/smallList.js"></script>
