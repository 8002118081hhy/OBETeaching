...
<form id="addForm" class="my-form" method="post">
    <table class="layui-table" style="margin:20px auto;width: 80%;">
        <tr>
            <td width="15%" align="center"><label>考核方案</label></td>
            <td width="35%" class="orderValue"><label>${score.assessid}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>得分</label></td>
            <td width="35%" class="orderValue"><label>${score.score}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>学生</label></td>
            <td width="35%" class="orderValue"><label>${score.studentid}</label></td>
        </tr>
    </table>
</form>
