...
<blockquote class="layui-elem-quote list_search">
    <div class="layui-inline">
        <a class="layui-btn layui-btn-normal addBtn"><i class="layui-icon">&#xe608;</i> 添加课程</a>
    </div>
    <div class="layui-inline">
...
<script type="text/javascript" src="${ctx}/view/manage/course/courseList.js"></script>
<script type="text/html" id="barEdit">
    <a class="layui-btn layui-btn-warm  layui-btn-xs" lay-event="infoDetail">查看</a>
    <a class="layui-btn layui-btn-warm  layui-btn-xs" lay-event="selectMB">查看课程目标</a>
