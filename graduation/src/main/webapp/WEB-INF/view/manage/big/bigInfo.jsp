...
<form id="addForm" class="my-form" method="post">
    <table class="layui-table" style="margin:20px auto;width: 80%;">
        <tr>
            <td width="25%" align="center"><label>名称</label></td>
            <td width="35%" class="orderValue"><label>${big.name}</label></td>
        </tr>
        <tr>
            <td width="25%" align="center"><label>毕业要求达成度</label></td>
            <td width="35%" class="orderValue"><label>${big.bigresult}</label></td>
        </tr>
    </table>
</form>
