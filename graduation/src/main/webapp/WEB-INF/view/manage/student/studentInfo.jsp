...
<form id="addForm" class="my-form" method="post">
    <table class="layui-table" style="margin:20px auto;width: 80%;">
        <tr>
            ...
            <td width="35%" class="orderValue"><label>${student.realname}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>性别</label></td>
            <td width="35%" class="orderValue"><label>${student.gender}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>生日</label></td>
            <td width="35%" class="orderValue"><label>${student.birthday}</label></td>
        </tr>
        <tr>
            <td width="15%" align="center"><label>班级</label></td>
            <td width="35%" class="orderValue"><label>${student.grade}</label></td>
        </tr>
    </table>
</form>
